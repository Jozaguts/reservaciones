...
{{-- <div class="container mt-3"> --}}
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row justify-content-end my-2">
                        <a href="#" class="btn btn-success" id="addUser" data-toggle="modal" data-target="#comisionistas"><span class="font-weight-bolder">+</span> Tipo de comisionista</a>
                    </div>
                {{-- alerts --}}
    ...
    <div class="modal fade" id="comisionistas" tabindex="-1" role="dialog" aria-labelledby="comisionistas" aria-hidden="true">
          ...
          <div class="modal-content ">
            <div class="modal-header">
              ...
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <tipo-comisionistas></tipo-comisionistas>
          </div>
        </div>
      </div>
    ...
    {{-- @include('modals.administration.register-form')
    @include('modals.administration.user-edit') --}}
</div>
