...
<!--                                                id="comisionista"-->
<!--                                                class="form-control"-->
<!--                                                v-model="comisionistaId"-->
<!--                                            >-->
<!--                                                <option disabled value="">Seleccione un comisionista</option>-->
<!--                                                <option v-for="comisionista in comisionistas" :key="comisionista.id" v-text="comisionista.nombre">-->

<!--                                                </option>-->

<!--                                            </select>-->
                                            <select-comisionistas>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td
                                                        colspan="7"
                                                        class="button-next-container"
                                                    >
                                                        <button
                                                            class="btn btn-success ml-auto p-2"
                                                            @click="e6 = 2"
                                                        >
                                                            Siguiente
                                                        </button>
...
export default {
    ...
    computed: {
        ...
        classAnticipoMinimo() {
            if (
                store.getters.getAnticipoMinimo <= store.getters.getTotalAbonos
            ) {
                return "bg-success";
            } else {
                return "bg-danger";
