             ...
             foreach ($datosPersonas as $datoPersona ) {
                ...
                for ($i=0; $i <$count2 ; $i++) { 
                    ...
                    $ActividadesHorario = ActividadesHorario::firstOrCreate(
                        ...
                        'l'=> $request->ArrayDeDIas[$i][0]['activado'],
                        'm'=> $request->ArrayDeDIas[$i][1]['activado'],
                        'x'=> $request->ArrayDeDIas[$i][2]['activado'],
                        'j'=> $request->ArrayDeDIas[$i][3]['activado'],
                        'v'=> $request->ArrayDeDIas[$i][4]['activado'],
                        's'=> $request->ArrayDeDIas[$i][5]['activado'],
                        'd'=> $request->ArrayDeDIas[$i][6]['activado'],
                        'active'=> 1,
                        'remove'=>0,
                        'usuarios_id'=> $request->get('idusuario')                            
                        ]
